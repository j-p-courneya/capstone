...
combinedSampleCorpus <- corpus(c(blogs_sample, news_sample, twitter_sample))
```
...
```{r}
blogtokens <- tokens(blogs_sample, remove_numbers = TRUE, remove_punct = TRUE, remove_separators = TRUE)
